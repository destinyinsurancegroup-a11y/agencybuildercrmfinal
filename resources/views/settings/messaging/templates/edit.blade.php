...
<div class="panel-card">
    ...
    <div class="panel-card-body">
        ...
        <form method="POST" action="{{ route('settings.messaging.templates.update', $messageTemplate->id) }}">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3">
                ...
                <select name="channel" class="form-control">
                    <option value="sms" {{ old('channel', $messageTemplate->channel) === 'sms' ? 'selected' : '' }}>SMS</option>
                    <option value="email" {{ old('channel', $messageTemplate->channel) === 'email' ? 'selected' : '' }}>Email</option>
                </select>
            ...
            <div class="mb-3">
                ...
                >{{ old('body', $messageTemplate->body) }}</textarea>
