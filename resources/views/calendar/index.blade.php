...
<!-- PAGE WRAPPER -->
<div style="padding: 32px 48px; background-color:#f5f5f5; min-height:100vh;">

    <h1 style="font-size: 32px; font-weight: 700; color:#111827;">Calendar</h1>
...
/* ------------------------------------------
   Remove Highlights / Borders / Pills
------------------------------------------ */
.fc-daygrid-day.fc-day-today { background:none !important; }
...
/* ------------------------------------------
   Event Text (Title + Time + Location)
------------------------------------------ */
.fc-event-title,
.fc-event-time {
    color:#111827 !important;
...
.modal-content {
    ...
    box-shadow:
        ...
        0 8px 16px -8px rgba(0,0,0,0.18) !important;
}
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button class="btn" id="saveEventBtn"
                        style="background:#c9a227; color:#000; font-weight:600;">
                    Save
                </button>
            </div>
