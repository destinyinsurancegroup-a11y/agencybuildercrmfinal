...
@section('title', 'Gideon Opportunities')

@section('content')
<div class="d-flex align-items-center justify-content-between mb-3">
    <div>
        <h3 class="mb-0" style="font-weight:700;">Gideon Opportunities</h3>
        <div class="text-muted" style="font-size: 13px;">
            Production-focused opportunities Gideon found for you.
        </div>
    </div>
...
<div class="mb-3">
    <div class="text-muted" style="font-size: 13px;">
        Status: <span id="gideonStatus">Ready</span>
    </div>
</div>
...
(function () {
    ...
    const statusEl = document.getElementById('gideonStatus');
        ...
        items.forEach(item => {
            ...
            row.innerHTML = `
                ...
                <div class="d-flex flex-column gap-2" style="min-width: 150px;">
                    <a href="${escapeHtml(item.open_url)}" class="btn btn-outline-dark btn-sm">Open</a>
