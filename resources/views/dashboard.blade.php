...
<style>
/* (UNCHANGED STYLES — your entire CSS kept as-is) */
    ...
    .goal-needed { font-size: 40px; font-weight: 900; color: #ffffff; }
...
<div class="dashboard-page">
    ...
    <div class="dashboard-grid">
        ...
        {{-- (REST OF YOUR GRID CARDS UNCHANGED) --}}
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    async function openActivityModal() {
        ...
        try {
            ...
            modalEl = document.getElementById("activityModal");
            if (!modalEl) {
                console.warn("Loaded /activity/popup but #activityModal was not found.");
                return;
            }
...
<!-- ✅ SINGLE SOURCE OF TRUTH: DASHBOARD SAVE HANDLER -->
<script>
(function(){
    ...
    window.ABC_activitySaveClick = async function(event) {
        ...
        // ✅ Hard global lock prevents double-submit
        ...
        try {
            ...
            // ✅ Normalize blanks to "0" so server gets consistent numbers
            ...
            // ✅ Try JSON response for month_totals
            let payload = null;
            const ct = (res.headers.get('content-type') || '').toLowerCase();
            if (ct.includes('application/json')) {
                payload = await res.json().catch(() => null);
            } else {
                // if server accidentally returned HTML, ignore and fallback to totals fetch
                payload = null;
            }

            // ✅ Refresh totals (prefer response month_totals, fallback to fetch)
            let monthTotals = null;
            if (payload && payload.month_totals) {
                monthTotals = payload.month_totals;
            } else {
                monthTotals = await fetchMonthTotals().catch(() => null);
            }
            ...
            // ✅ Close modal last (so errors can show if needed)
