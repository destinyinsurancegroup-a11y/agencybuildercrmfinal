    ...
    <div class="panel-card-body">
        ...
        <form method="POST" action="{{ route('settings.messaging.templates.store') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="e.g. Welcome Email - Day 0">
                @error('name') <div class="text-danger mt-1">{{ $message }}</div> @enderror
            </div>

            <div class="mb-3">
                <label class="form-label">Subject (Email only)</label>
                <input type="text" name="subject" class="form-control" value="{{ old('subject') }}" placeholder="e.g. Welcome, {{'{{first_name}}'}}">
            ...
            <div class="mb-3">
                ...
                <textarea name="body" class="form-control" rows="8" placeholder="Write your message here...">{{ old('body') }}</textarea>
